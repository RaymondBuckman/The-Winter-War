                ...
                <div className="container">
                    ...
                    <div className="row">
                        <p id="home-field-advantage-paragraph" className="col-xs-7 col-xs-offset-0 text-left">
                            ...
                            For the Soviet Union it was completely different. It was used to war games on large expanses of open ground. The snow covered forests of Finland were a different matter and the Russians were to find that they were frequently confined to the area around roads as many of their men were unused to Finland’s terrain and the majority of their vehicles were unable to go off road. Their tactics developed during training did not include such terrain.<br/><br/>
