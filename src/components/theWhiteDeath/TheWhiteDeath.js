            ...
            <div className="the-white-death-div">
                <div className="container">
                    ...
                    <div className="row">
                        ...
                        <div id="simo-hayha" className="col-xs-4 col-xs-offset-8" data-tip data-for="simo-hayha-tooltip"></div>
                    </div>
                </div>
            </div>
