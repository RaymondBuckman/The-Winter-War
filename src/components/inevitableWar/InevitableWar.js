        ...
        <div>
            <div id="inevitable-war-div" className="inevitable-war-div">
                <div className="container">
                    ...
                    <div className="row">
                        <div id="inevitable-war-image" className="col-lg-4 col-lg-offset-0 hidden-xs">
                        ...
                        <p id="inevitable-war-paragraph" className="col-xs-10 col-xs-offset-1 col-lg-7 col-lg-offset-5 text-right">
