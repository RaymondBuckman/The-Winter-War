        ...
        <div>
            <div id="the-treaty-of-moscow-div" className="the-treaty-of-moscow-div">
                <div className="container">
                    ...
                    <div className="row">
                        <p id="the-treaty-of-moscow-paragraph" className="col-xs-10 col-xs-offset-1 col-lg-7 col-lg-offset-0 text-left">
                        ...
                        <div id="the-treaty-of-moscow-image" className="col-lg-4 col-lg-offset-8 hidden-xs hidden-sm" onMouseEnter={this.darken.bind(this)} onMouseLeave={this.lighten.bind(this)}>
